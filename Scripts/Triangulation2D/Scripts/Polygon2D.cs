...
namespace mattatz.Triangulation2DSystem {
	...
	public class Polygon2D {
		...
		public Vertex2D[] VertexArray { get { return vertices.ToArray(); } }
		public Segment2D[] SegmentArray { get { return segments.ToArray(); } }

		public List<Vertex2D> Vertices => vertices;
		public List<Segment2D> Segments => segments;
